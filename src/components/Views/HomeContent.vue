...
<template>
  ...
  <div class="max-w-7xl mx-auto px-4 mt-16">
    ...
    <div
      ...
      <div v-for="product in products" :key="product.id" class="w-full max-w-[270px] group cursor-pointer"
        @click="goToProductsDetail(product)">
        <div
          ...
          <div class="absolute top-4 right-4 flex flex-col gap-3 opacity-100 sm:opacity-0 sm:group-hover:opacity-100
          ...
          <button @click.stop="addToCart(product)"
            class="absolute bottom-0 left-0 w-full h-12 bg-black text-white
         font-medium opacity-100 sm:opacity-0
         sm:group-hover:opacity-100
         sm:translate-y-full sm:group-hover:translate-y-0
         transition-all duration-300 hover:bg-gray-900 z-10">
            Add To Cart
          </button>
        </div>
    ...
    <div class="flex justify-center mt-8">
      <button
        class="bg-[#DB4444] text-white px-8 sm:px-12 py-3 sm:py-4 rounded hover:bg-red-600 transition text-base sm:text-lg font-medium">
        View All Products
      </button>
    </div>
  </div>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 px-4 py-5 sm:py-10 justify-items-center">
    <div
      class="flex flex-col items-center justify-center w-full h-[120px] sm:h-[145px] rounded-sm border border-gray-500 hover:bg-[#DB4444] cursor-pointer">
    ...
    <div
      ...
      <div v-for="product in products" :key="product.id" class="w-full max-w-[270px] group cursor-pointer"
        ...
        <div
          class="relative bg-[#F5F5F5] h-[250px] rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
          <div
            class="absolute top-4 right-4 flex flex-col gap-3 opacity-100 sm:opacity-0 sm:group-hover:opacity-100
 transition-opacity duration-300 z-10">
            <button @click.stop="addToWishlist(product)"
              class="w-10 h-10 bg-white rounded-full shadow-lg hover:scale-110 transition">
              <img src="/assets/Vector4.png" class="w-5 h-5 mx-auto" alt="Wishlist" />
    ...
    <div
      class="flex flex-col lg:flex-row justify-between items-center w-full max-w-[1170px] mx-auto lg:ml-10 h-auto lg:h-[500px] bg-black p-4 sm:p-10 mt-10 sm:mt-20 gap-4 lg:gap-0">
      <div class="flex flex-col items-center lg:items-start gap-2 text-center lg:text-left">
        ...
        <span class="text-2xl sm:text-[48px] text-white font-bold leading-tight">Enhance Your<br
            class="hidden lg:block"> Music Experience</span>
        <div class="flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-4 mt-4">
          <div
            class="rounded-full w-12 h-12 sm:w-[62px] sm:h-[62px] bg-white items-center justify-center flex flex-col">
        ...
        <button
          class="bg-[#00FF66] text-white text-xs sm:text-sm w-full sm:w-[171px] h-[40px] sm:h-[56px] rounded-sm hover:bg-[#DB4444] cursor-pointer mt-4">
          Buy Now!
        </button>
      </div>
      <div class="relative w-full lg:w-fit flex justify-center lg:items-center h-auto lg:h-[500px]">
        <img src="/assets/Ellipse 23.png"
          class="w-full max-w-[568px] h-auto lg:h-[500px] absolute top-[-40px] lg:top-[-80px] left-0 z-0" />
 ...
 transition-opacity duration-300 z-10">
    ...
    <div
      class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 lg:gap-8 mt-10 justify-items-center">
      <div v-for="(product, index) in products" :key="product.id" class="w-full max-w-[270px] group cursor-pointer"
        @click="goToProductDetail(product)">
        <div
          class="relative bg-[#F5F5F5] h-[250px] rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
